...
-  Fork this [repository](https://github.com/DeepNinja07x/Google-Black-Theme)
  
-  Clone the forked https://github.com/<Your_Username>/Google-Black-Theme
    > git clone https://github.com/<Your_Username>/Google-Black-Theme.git
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Google-Black-Theme.git
